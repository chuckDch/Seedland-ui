<template>
  <transition name="sd-zoom-in-top" @after-leave="$emit('dodestroy')">
    <div
      v-show="visible"
      class="sd-time-panel sd-popper"
      :class="popperClass">
      <div class="sd-time-panel__content" :class="{ 'has-seconds': showSeconds }">
        <time-spinner
          ref="spinner"
          @change="handleChange"
...
<script type="text/babel">
  import { limitTimeRange, isDate, clearMilliseconds, timeWithinRange } from 'seedland-ui/src/utils/date-util';
