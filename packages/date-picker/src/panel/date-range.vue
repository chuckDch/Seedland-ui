    ...
    <div
      ...
      <div class="sd-picker-panel__body-wrapper">
        ...
        <div class="sd-picker-panel__body">
          <div class="sd-date-range-picker__time-header" v-if="showTime">
            <span class="sd-date-range-picker__editors-wrap">
              <span class="sd-date-range-picker__time-picker-wrap">
                <sd-input
                  size="small"
                  :disabled="rangeState.selecting"
                  ref="minInput"
                  :placeholder="t('el.datepicker.startDate')"
                  class="sd-date-range-picker__editor"
                  :value="minVisibleDate"
                  @input="val => handleDateInput(val, 'min')"
                  @change="val => handleDateChange(val, 'min')" />
              </span>
              <span class="sd-date-range-picker__time-picker-wrap" v-clickoutside="handleMinTimeClose">
                <sd-input
                  size="small"
                  class="sd-date-range-picker__editor"
                  :disabled="rangeState.selecting"
            ...
            <span class="sd-icon-arrow-right"></span>
            <span class="sd-date-range-picker__editors-wrap is-right">
              <span class="sd-date-range-picker__time-picker-wrap">
                <sd-input
                  size="small"
                  class="sd-date-range-picker__editor"
              ...
              <span class="sd-date-range-picker__time-picker-wrap" v-clickoutside="handleMaxTimeClose">
                <sd-input
                  size="small"
                  class="sd-date-range-picker__editor"
                  :disabled="rangeState.selecting"
          ...
          <div class="sd-picker-panel__content sd-date-range-picker__content is-left">
            <div class="sd-date-range-picker__header">
              ...
              <button
                type="button"
                @click="leftPrevMonth"
                class="sd-picker-panel__icon-btn sd-icon-arrow-left"></button>
              <button
                type="button"
                @click="leftNextYear"
                v-if="unlinkPanels"
              ...
              <button
                ...
                class="sd-picker-panel__icon-btn sd-icon-arrow-right"></button>
              <div>{{ leftLabel }}</div>
            </div>
            <date-table
      ...
      <div class="sd-picker-panel__footer" v-if="showTime">
        <sd-button
          size="mini"
          type="text"
...
<script type="text/babel">
  import {
    ...
    extractDateFormat,
    extractTimeFormat
  } from 'seedland-ui/src/utils/date-util';
  import Clickoutside from 'seedland-ui/src/utils/clickoutside';
  import Locale from 'seedland-ui/src/mixins/locale';
  import TimePicker from './time';
  import DateTable from '../basic/date-table';
  import ElInput from 'seedland-ui/packages/input';
  import ElButton from 'seedland-ui/packages/button';
