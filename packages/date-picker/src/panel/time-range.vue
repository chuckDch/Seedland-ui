<template>
  <transition
    ...
    <div
      v-show="visible"
      class="sd-time-range-picker sd-picker-panel sd-popper"
      :class="popperClass">
      <div class="sd-time-range-picker__content">
        <div class="sd-time-range-picker__cell">
          <div class="sd-time-range-picker__header">{{ t('el.datepicker.startTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="sd-time-range-picker__body sd-time-panel__content">
            <time-spinner
              ref="minSpinner"
        ...
        <div class="sd-time-range-picker__cell">
          <div class="sd-time-range-picker__header">{{ t('el.datepicker.endTime') }}</div>
          <div
            :class="{ 'has-seconds': showSeconds, 'is-arrow': arrowControl }"
            class="sd-time-range-picker__body sd-time-panel__content">
            <time-spinner
      ...
      <div class="sd-time-panel__footer">
        <button
          type="button"
          class="sd-time-panel__btn cancel"
          @click="handleCancel()">{{ t('el.datepicker.cancel') }}</button>
        <button
          type="button"
          class="sd-time-panel__btn confirm"
          @click="handleConfirm()"
