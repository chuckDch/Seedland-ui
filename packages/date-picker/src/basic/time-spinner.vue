<template>
  <div class="sd-time-spinner" :class="{ 'has-seconds': showSeconds }">
    <template v-if="!arrowControl">
      <sd-scrollbar
        @mouseenter.native="emitSelectRange('hours')"
        @mousemove.native="adjustCurrentSpinner('hours')"
        class="sd-time-spinner__wrapper"
    ...
    <template v-if="arrowControl">
      <div
        ...
        class="sd-time-spinner__wrapper is-arrow">
        <i v-repeat-click="decrease" class="sd-time-spinner__arrow sd-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="sd-time-spinner__arrow sd-icon-arrow-down"></i>
        <ul class="sd-time-spinner__list" ref="hours">
          <li
            class="sd-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="sd-time-spinner__arrow sd-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="sd-time-spinner__arrow sd-icon-arrow-down"></i>
        <ul class="sd-time-spinner__list" ref="minutes">
          <li
            class="sd-time-spinner__item"
      ...
      <div
        ...
        <i v-repeat-click="decrease" class="sd-time-spinner__arrow sd-icon-arrow-up"></i>
        <i v-repeat-click="increase" class="sd-time-spinner__arrow sd-icon-arrow-down"></i>
        <ul class="sd-time-spinner__list" ref="seconds">
          <li
...
<script type="text/babel">
  import { getRangeHours, getRangeMinutes, modifyTime } from 'seedland-ui/src/utils/date-util';
