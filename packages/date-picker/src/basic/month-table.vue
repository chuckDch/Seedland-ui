<template>
  <table @click="handleMonthTableClick" @mousemove="handleMouseMove" class="sd-month-table">
    <tbody>
...
<script type="text/babel">
  ...
  import { isDate, range, getDayCountOfMonth, nextDate } from 'seedland-ui/src/utils/date-util';
  import { hasClass } from 'seedland-ui/src/utils/dom';
  import { arrayFindIndex, coerceTruthyValueToArray, arrayFind } from 'seedland-ui/src/utils/util';
