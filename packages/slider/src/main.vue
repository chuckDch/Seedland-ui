<template>
  <div
    class="sd-slider"
    :class="{ 'is-vertical': vertical, 'sd-slider--with-input': showInput }"
    role="slider"
    :aria-valuemin="min"
    :aria-valuemax="max"
      ...
      <template v-if="markList.length > 0">
        <div>
          <div
            ...
            class="sd-slider__stop sd-slider__marks-stop"
            :key="key">
          </div>
        </div>
        <div class="sd-slider__marks">
          <slider-marker
    ...
    computed: {
      stops() {
        ...
        if (this.step === 0) {
          ...
          console.warn('[Seedland Warn][Slider]step should not be 0.');
          return [];
        }
