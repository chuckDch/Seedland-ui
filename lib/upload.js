...
module.exports = require("seedland-ui/lib/progress");
...
var upload_listvue_type_template_id_173fedf5_render = function() {
  ...
  return _c(
    "transition-group",
    {
      class: [
        "sd-upload-list",
        "sd-upload-list--" + _vm.listType,
        { "is-disabled": _vm.disabled }
      ],
      attrs: { tag: "ul", name: "sd-list" }
    },
      ...
      return _c(
        ...
        [
          ...
          ["picture-card", "picture"].indexOf(_vm.listType) > -1
            ? _c("img", {
                staticClass: "sd-upload-list__item-thumbnail",
          ...
          _c(
            "a",
            {
              staticClass: "sd-upload-list__item-name",
              on: {
                click: function($event) {
            ...
            [
              _c("i", { staticClass: "sd-icon-document" }),
              _vm._v(_vm._s(file.name) + "\n    ")
            ]
          ),
          _c("label", { staticClass: "sd-upload-list__item-status-label" }, [
            _c("i", {
              class: {
                "sd-icon-upload-success": true,
                "sd-icon-circle-check": _vm.listType === "text",
                "sd-icon-check":
                  ["picture-card", "picture"].indexOf(_vm.listType) > -1
              }
            })
          ...
          !_vm.disabled
            ...
            : _vm._e(),
          !_vm.disabled
            ? _c("i", { staticClass: "sd-icon-close-tip" }, [
          ...
          _vm.listType === "picture-card"
            ? _c("span", { staticClass: "sd-upload-list__item-actions" }, [
                _vm.handlePreview && _vm.listType === "picture-card"
                  ? _c(
                      "span",
                      {
                        staticClass: "sd-upload-list__item-preview",
                        on: {
                          click: function($event) {
                      ...
                      [_c("i", { staticClass: "sd-icon-zoom-in" })]
                    )
                  : _vm._e(),
                !_vm.disabled
                  ? _c(
                      "span",
                      {
                        staticClass: "sd-upload-list__item-delete",
                        on: {
                          click: function($event) {
                            _vm.$emit("remove", file)
                          }
                      ...
                      [_c("i", { staticClass: "sd-icon-delete" })]
                    )
                  : _vm._e()
              ])
            : _vm._e()
...
// EXTERNAL MODULE: external "seedland-ui/lib/progress"
...
/* harmony default export */ var upload_listvue_type_script_lang_js_ = ({
  ...
  components: { SdProgress: progress_default.a },
...
/* harmony default export */ var uploadvue_type_script_lang_js_ = ({
  ...
  render: function render(h) {
    ...
    data.class['sd-upload--' + listType] = true;
    return h(
      'div',
      ...
      [drag ? h(
        ...
        [this.$slots.default]
      ) : this.$slots.default, h('input', { 'class': 'sd-upload__input', attrs: { type: 'file', name: name, multiple: multiple, accept: accept },
        ref: 'input', on: {
          'change': handleChange
        }
      })]
