    ...
    [
      _c(
        "div",
        {
          ...
          class: [
            "sd-message",
            _vm.type && !_vm.iconClass ? "sd-message--" + _vm.type : "",
        ...
        [
          ...
          _vm._t("default", [
            !_vm.dangerouslyUseHTMLString
              ? _c("p", { staticClass: "sd-message__content" }, [
                  _vm._v(_vm._s(_vm.message))
                ])
              : _c("p", {
                  staticClass: "sd-message__content",
                  domProps: { innerHTML: _vm._s(_vm.message) }
                })
          ]),
          _vm.showClose
            ? _c("i", {
                staticClass: "sd-message__closeBtn sd-icon-close",
                on: { click: _vm.close }
              })
            : _vm._e()
        ],
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  computed: {
    typeClass: function typeClass() {
      return this.type && !this.iconClass ? 'sd-message__icon sd-icon-' + typeMap[this.type] : '';
    }
  },
