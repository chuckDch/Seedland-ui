...
/* harmony default export */ var submenuvue_type_script_lang_js_ = ({
  ...
  render: function render(h) {
    ...
    var inlineMenu = h('sd-collapse-transition', [h(
      'ul',
      {
        attrs: {
          role: 'menu'
    ...
    var submenuTitleIcon = rootMenu.mode === 'horizontal' && isFirstLevel || rootMenu.mode === 'vertical' && !rootMenu.collapse ? 'sd-icon-arrow-down' : 'sd-icon-arrow-right';
    ...
    return h(
      ...
      [h(
        ...
        [$slots.title, h('i', { 'class': ['sd-submenu__icon-arrow', submenuTitleIcon] })]
...
/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  computed: {
    ...
    parentMenu: function parentMenu() {
      var parent = this.$parent;
      while (parent && ['SdMenu', 'SdSubmenu'].indexOf(parent.$options.componentName) === -1) {
        parent = parent.$parent;
      }
      return parent;
    },
