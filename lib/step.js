...
var render = function() {
  ...
  return _c(
    ...
    [
      _c(
        "div",
        { staticClass: "sd-step__head", class: "is-" + _vm.currentStatus },
        [
          _c(
            "div",
            {
              staticClass: "sd-step__line",
              style: _vm.isLast
                ? ""
            ...
            [
              _c("i", {
                staticClass: "sd-step__line-inner",
                style: _vm.lineStyle
              })
            ]
          ),
            ...
            [
              _vm.currentStatus !== "success" && _vm.currentStatus !== "error"
                ? _vm._t("icon", [
                    _vm.icon
                      ? _c("i", {
                          staticClass: "sd-step__icon-inner",
                          class: [_vm.icon]
                        })
                      : _vm._e(),
                    !_vm.icon && !_vm.isSimple
                      ? _c("div", { staticClass: "sd-step__icon-inner" }, [
                          _vm._v(_vm._s(_vm.index + 1))
                        ])
                      : _vm._e()
                  ])
                : _c("i", {
                    staticClass: "sd-step__icon-inner is-status",
                    class: [
                      "sd-icon-" +
      ...
      _c("div", { staticClass: "sd-step__main" }, [
        _c(
          "div",
          {
            ref: "title",
            staticClass: "sd-step__title",
        ...
        _vm.isSimple
          ? _c("div", { staticClass: "sd-step__arrow" })
          : _c(
              "div",
              {
                staticClass: "sd-step__description",
                class: ["is-" + _vm.currentStatus]
              },
