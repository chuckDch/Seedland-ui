...
module.exports = require("seedland-ui/lib/utils/date");
...
var render = function() {
  ...
  return _c("div", { staticClass: "sd-calendar" }, [
    _c("div", { staticClass: "sd-calendar__header" }, [
      _c("div", { staticClass: "sd-calendar__title" }, [
        _vm._v("\n      " + _vm._s(_vm.i18nDate) + "\n    ")
      ]),
      _vm.validatedRange.length === 0
        ? _c(
            "div",
            { staticClass: "sd-calendar__button-group" },
            [
              _c(
                "sd-button-group",
                [
    ...
    _vm.validatedRange.length === 0
      ? _c(
          "div",
          { key: "no-range", staticClass: "sd-calendar__body" },
          [
            _c("date-table", {
      ...
      : _c(
          "div",
          { key: "has-range", staticClass: "sd-calendar__body" },
...
// EXTERNAL MODULE: external "seedland-ui/lib/utils/date"
...
/* harmony default export */ var date_tablevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    cellRenderProxy: function cellRenderProxy(_ref3) {
      ...
      var render = this.sdCalendar.$scopedSlots.dateCell;
        ...
        return h(
          'tr',
          {
            'class': {
              ...
              'sd-calendar-table__row--hide-border': index === 0 && _this.hideHeader
            },
            key: index },
