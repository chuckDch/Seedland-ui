...
var render = function() {
  ...
  return _c("transition", { attrs: { name: "sd-notification-fade" } }, [
    _c(
      "div",
      {
        directives: [
        ...
        class: ["sd-notification", _vm.customClass, _vm.horizontalClass],
      ...
      [
        _vm.type || _vm.iconClass
          ? _c("i", {
              staticClass: "sd-notification__icon",
        ...
        _c(
          "div",
          {
            staticClass: "sd-notification__group",
            class: { "is-with-icon": _vm.typeClass || _vm.iconClass }
          },
          [
            _c("h2", {
              staticClass: "sd-notification__title",
            ...
            _c(
              "div",
              {
                ...
                staticClass: "sd-notification__content"
              },
              [
                _vm._t("default", [
            ...
            _vm.showClose
              ? _c("div", {
                  staticClass: "sd-notification__closeBtn sd-icon-close",
                  on: {
