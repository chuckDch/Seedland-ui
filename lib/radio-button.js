...
var render = function() {
  ...
  return _c(
    "label",
    {
      staticClass: "sd-radio-button",
      class: [
        _vm.size ? "sd-radio-button--" + _vm.size : "",
    ...
    [
      _c("input", {
        ...
        staticClass: "sd-radio-button__orig-radio",
        attrs: {
          type: "radio",
          name: _vm.name,
      ...
      _c(
        "span",
        {
          staticClass: "sd-radio-button__inner",
  ...
  methods: {
    handleChange: function handleChange() {
      ...
      this.$nextTick(function () {
        _this.dispatch('SdRadioGroup', 'handleChange', _this.value);
      });
    }
  }
});
