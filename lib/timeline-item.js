...
var render = function() {
  ...
  return _c("li", { staticClass: "sd-timeline-item" }, [
    _c("div", { staticClass: "sd-timeline-item__tail" }),
    !_vm.$slots.dot
      ? _c(
          "div",
          {
            staticClass: "sd-timeline-item__node",
            class: [
              "sd-timeline-item__node--" + (_vm.size || ""),
              "sd-timeline-item__node--" + (_vm.type || "")
            ],
            style: {
          ...
          [
            _vm.icon
              ? _c("i", {
                  staticClass: "sd-timeline-item__icon",
                  class: _vm.icon
                })
              : _vm._e()
          ]
      ...
      : _vm._e(),
    _vm.$slots.dot
      ? _c("div", { staticClass: "sd-timeline-item__dot" }, [_vm._t("dot")], 2)
      : _vm._e(),
    _c("div", { staticClass: "sd-timeline-item__wrapper" }, [
      !_vm.hideTimestamp && _vm.placement === "top"
        ? _c("div", { staticClass: "sd-timeline-item__timestamp is-top" }, [
            _vm._v("\n      " + _vm._s(_vm.timestamp) + "\n    ")
          ])
        : _vm._e(),
      _c(
        "div",
        { staticClass: "sd-timeline-item__content" },
        [_vm._t("default")],
        2
      ),
      !_vm.hideTimestamp && _vm.placement === "bottom"
        ? _c("div", { staticClass: "sd-timeline-item__timestamp is-bottom" }, [
            _vm._v("\n      " + _vm._s(_vm.timestamp) + "\n    ")
          ])
        : _vm._e()
    ])
