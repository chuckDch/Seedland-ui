  ...
  return _c(
    "div",
    {
      ...
      class: [
        ...
        _vm.colorSize ? "sd-color-picker--" + _vm.colorSize : ""
      ]
    },
    [
      _vm.colorDisabled
        ? _c("div", { staticClass: "sd-color-picker__mask" })
        : _vm._e(),
      _c(
        "div",
        {
          staticClass: "sd-color-picker__trigger",
        ...
        [
          _c(
            "span",
            {
              staticClass: "sd-color-picker__color",
              class: { "is-alpha": _vm.showAlpha }
            },
            [
              _c("span", {
                staticClass: "sd-color-picker__color-inner",
                style: {
              ...
              !_vm.value && !_vm.showPanelColor
                ? _c("span", {
                    staticClass: "sd-color-picker__empty sd-icon-close"
                  })
                : _vm._e()
            ]
          ),
          _c("span", {
            ...
            staticClass: "sd-color-picker__icon sd-icon-arrow-down"
          })
        ]
      ),
      _c("picker-dropdown", {
        ref: "dropdown",
        class: ["sd-color-picker__panel", _vm.popperClass || ""],
        attrs: {
          color: _vm.color,
...
var picker_dropdownvue_type_template_id_06601625_render = function() {
  ...
  return _c(
    "transition",
    { attrs: { name: "sd-zoom-in-top" }, on: { "after-leave": _vm.doDestroy } },
    [
      _c(
        "div",
        {
          ...
          staticClass: "sd-color-dropdown"
        },
        [
          _c(
            "div",
            { staticClass: "sd-color-dropdown__main-wrapper" },
            [
              _c("hue-slider", {
                ref: "hue",
          ...
          _c(
            "div",
            { staticClass: "sd-color-dropdown__btns" },
            [
              _c(
                "span",
                { staticClass: "sd-color-dropdown__value" },
                [
                  _c("sd-input", {
              ...
              _c(
                "sd-button",
                {
                  staticClass: "sd-color-dropdown__link-btn",
              ...
              _c(
                "sd-button",
                {
                  staticClass: "sd-color-dropdown__btn",
...
var sv_panelvue_type_template_id_d8583596_render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "sd-color-svpanel",
      style: {
        backgroundColor: _vm.background
      }
    },
    [
      _c("div", { staticClass: "sd-color-svpanel__white" }),
      _c("div", { staticClass: "sd-color-svpanel__black" }),
      _c(
        "div",
        {
          staticClass: "sd-color-svpanel__cursor",
          style: {
...
var hue_slidervue_type_template_id_5cdc43b1_render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "sd-color-hue-slider",
      class: { "is-vertical": _vm.vertical }
    },
    [
      _c("div", {
        ref: "bar",
        staticClass: "sd-color-hue-slider__bar",
        on: { click: _vm.handleClick }
      }),
      _c("div", {
        ref: "thumb",
        staticClass: "sd-color-hue-slider__thumb",
        style: {
...
var alpha_slidervue_type_template_id_068c66cb_render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "sd-color-alpha-slider",
      class: { "is-vertical": _vm.vertical }
    },
    [
      _c("div", {
        ref: "bar",
        staticClass: "sd-color-alpha-slider__bar",
        style: {
      ...
      _c("div", {
        ref: "thumb",
        staticClass: "sd-color-alpha-slider__thumb",
        style: {
          left: _vm.thumbLeft + "px",
          top: _vm.thumbTop + "px"
        }
...
var predefinevue_type_template_id_06e03093_render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "sd-color-predefine" }, [
    _c(
      "div",
      { staticClass: "sd-color-predefine__colors" },
      _vm._l(_vm.rgbaColors, function(item, index) {
        return _c(
          "div",
          {
            key: _vm.colors[index],
            staticClass: "sd-color-predefine__color-selector",
