...
module.exports = require("seedland-ui/lib/input-number");
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "sd-slider",
      class: {
        "is-vertical": _vm.vertical,
        "sd-slider--with-input": _vm.showInput
      },
      attrs: {
        role: "slider",
    ...
    [
      ...
      _c(
        ...
        {
          ref: "slider",
          staticClass: "sd-slider__runway",
          class: { "show-input": _vm.showInput, disabled: _vm.sliderDisabled },
          style: _vm.runwayStyle,
          on: { click: _vm.onSliderClick }
        },
        [
          _c("div", { staticClass: "sd-slider__bar", style: _vm.barStyle }),
          _c("slider-button", {
            ref: "button1",
            attrs: {
            ...
            ? [
                _c(
                  ...
                  _vm._l(_vm.markList, function(item, key) {
                    return _c("div", {
                      key: key,
                      staticClass: "sd-slider__stop sd-slider__marks-stop",
...
// EXTERNAL MODULE: external "seedland-ui/lib/input-number"
...
var buttonvue_type_template_id_e72d2ad2_render = function() {
  ...
  return _c(
    ...
    {
      ref: "button",
      staticClass: "sd-slider__button-wrapper",
...
/* harmony default export */ var marker = ({
  ...
  render: function render() {
    ...
    return h(
      'div',
      { 'class': 'sd-slider__marks-text', style: this.mark.style || {} },
      [label]
    );
  }
});
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  components: {
    SdInputNumber: input_number_default.a,
  ...
  methods: {
    ...
    setValues: function setValues() {
      if (this.min > this.max) {
        console.error('[Seedland Error][Slider]min should not be greater than max.');
        return;
      }
      var val = this.value;
      if (this.range && Array.isArray(val)) {
        if (val[1] < this.min) {
          ...
          if (this.valueChanged()) {
            this.dispatch('SdFormItem', 'el.form.change', [this.minValue, this.maxValue]);
