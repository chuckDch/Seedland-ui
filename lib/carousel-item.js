...
var render = function() {
  ...
  return _c(
    "div",
    {
      ...
      staticClass: "sd-carousel__item",
      class: {
        "is-active": _vm.active,
        "sd-carousel__item--card": _vm.$parent.type === "card",
    ...
    translateItem: function translateItem(index, activeIndex, oldIndex) {
      ...
      if (parentType === 'card') {
        if (parentDirection === 'vertical') {
          console.warn('[Seedland Warn][Carousel]vertical directionis not supported in card mode');
        }
