...
var mainvue_type_template_id_2e869fa1_render = function() {
  ...
  return _c(
    "span",
    {
      ...
      ref: "reference",
      staticClass: "sd-cascader",
      class: [
        {
          "is-opened": _vm.menuVisible,
          "is-disabled": _vm.cascaderDisabled
        },
        _vm.cascaderSize ? "sd-cascader--" + _vm.cascaderSize : ""
      ],
      on: {
    ...
    [
          ...
          _c("template", { slot: "suffix" }, [
            _vm.clearable && _vm.inputHover && _vm.currentLabels.length
              ? _c("i", {
                  key: "1",
                  staticClass:
                    "sd-input__icon sd-icon-circle-close sd-cascader__clearIcon",
                  on: { click: _vm.clearValue }
                })
              : _c("i", {
                  key: "2",
                  staticClass: "sd-input__icon sd-icon-arrow-down",
      ...
      _c(
        "span",
        {
          ...
          staticClass: "sd-cascader__label"
        },
        [
          _vm.showAllLevels
            ? [
    ...
    return h(
      ...
      [h(
        'div',
        {
          ...
          'class': ['sd-cascader-menus sd-popper', popperClass],
          ref: 'wrapper'
        },
        [h('div', {
          attrs: { 'x-arrow': true },
  ...
  methods: {
    ...
    handleKeydown: function handleKeydown(e) {
      ...
      if (keyCode === 13) {
        ...
        setTimeout(function () {
          var firstMenu = _this4.popperElm.querySelectorAll('.sd-cascader-menu')[0];
    ...
    highlightKeyword: function highlightKeyword(label, keyword) {
      ...
      return label.split(keyword).map(function (node, index) {
        return index === 0 ? node : [h('span', { class: { 'sd-cascader-menu__item__keyword': true } }, [_this7._v(keyword)]), node];
      });
    },
