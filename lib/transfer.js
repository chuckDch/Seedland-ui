...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "div",
        { staticClass: "sd-transfer__buttons" },
        [
          _c(
            "sd-button",
            {
            ...
            [
              _c("i", { staticClass: "sd-icon-arrow-left" }),
          ...
          _c(
            ...
            [
              _vm.buttonTexts[1] !== undefined
                ...
                : _vm._e(),
              _c("i", { staticClass: "sd-icon-arrow-right" })
            ]
          )
        ],
        1
...
var transfer_panelvue_type_template_id_2ddab8bd_render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "sd-transfer-panel" }, [
    _c(
      "p",
      { staticClass: "sd-transfer-panel__header" },
      [
        _c(
          "sd-checkbox",
          {
      ...
      [
        _vm.filterable
          ? _c(
              "sd-input",
              {
                staticClass: "sd-transfer-panel__filter",
              ...
              [
                _c("i", {
                  class: ["sd-input__icon", "sd-icon-" + _vm.inputIcon],
                  attrs: { slot: "prefix" },
        ...
        _c(
          "sd-checkbox-group",
          {
            ...
            staticClass: "sd-transfer-panel__list",
          ...
          _vm._l(_vm.filteredData, function(item) {
            return _c(
              "sd-checkbox",
              {
                ...
                staticClass: "sd-transfer-panel__item",
                attrs: {
        ...
        _c(
          "p",
          {
            ...
            staticClass: "sd-transfer-panel__empty"
          },
    ...
    _vm.hasFooter
      ? _c(
          "p",
          { staticClass: "sd-transfer-panel__footer" },
          [_vm._t("default")],
          2
        )
      : _vm._e()
...
/* harmony default export */ var transfer_panelvue_type_script_lang_js_ = ({
  ...
  name: 'SdTransferPanel',

  componentName: 'SdTransferPanel',
    ...
    OptionContent: {
      ...
      render: function render(h) {
        var getParent = function getParent(vm) {
          if (vm.$options.componentName === 'SdTransferPanel') {
            return vm;
          } else if (vm.$parent) {
