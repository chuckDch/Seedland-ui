    ...
    [
      _c(
        "div",
        {
          ...
          ref: "popper",
          staticClass: "sd-picker-panel time-select sd-popper",
        ...
        [
          _c(
            "sd-scrollbar",
            {
              attrs: { noresize: "", "wrap-class": "sd-picker-panel__content" }
            },
...
/* harmony default export */ var time_selectvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    scrollToOption: function scrollToOption() {
      ...
      var menu = this.$refs.popper.querySelector('.sd-picker-panel__content');
