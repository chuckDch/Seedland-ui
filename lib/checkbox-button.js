...
var render = function() {
  ...
  return _c(
    "label",
    {
      staticClass: "sd-checkbox-button",
      class: [
        _vm.size ? "sd-checkbox-button--" + _vm.size : "",
    ...
    [
      _vm.trueLabel || _vm.falseLabel
        ? _c("input", {
            ...
            staticClass: "sd-checkbox-button__original",
            attrs: {
              type: "checkbox",
              name: _vm.name,
      ...
      _vm.$slots.default || _vm.label
        ? _c(
            "span",
            {
              staticClass: "sd-checkbox-button__inner",
...
/* harmony default export */ var checkbox_buttonvue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    isDisabled: function isDisabled() {
      return this._checkboxGroup ? this._checkboxGroup.disabled || this.disabled || (this.sdForm || {}).disabled : this.disabled || (this.sdForm || {}).disabled;
    }
  },
  methods: {
