  ...
  return _c(
    ...
    [
      ...
      _vm.showText || _vm.showScore
        ? _c(
            "span",
            { staticClass: "sd-rate__text", style: { color: _vm.textColor } },
...
// EXTERNAL MODULE: external "seedland-ui/lib/utils/types"
...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  props: {
    ...
    iconClasses: {
      type: [Array, Object],
      default: function _default() {
        return ['sd-icon-star-on', 'sd-icon-star-on', 'sd-icon-star-on'];
      }
    },
    voidIconClass: {
      type: String,
      default: 'sd-icon-star-off'
    },
    disabledVoidIconClass: {
      type: String,
      default: 'sd-icon-star-on'
    },
    disabled: {
      type: Boolean,
      default: false
  ...
  methods: {
    ...
    setCurrentValue: function setCurrentValue(value, event) {
      ...
      if (this.allowHalf) {
        ...
        if (Object(dom_["hasClass"])(target, 'sd-rate__item')) {
          target = target.querySelector('.sd-rate__icon');
        }
        if (Object(dom_["hasClass"])(target, 'sd-rate__decimal')) {
...
module.exports = require("seedland-ui/lib/utils/types");
