...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "sd-form-item",
      class: [
        {
          "sd-form-item--feedback": _vm.sdForm && _vm.sdForm.statusIcon,
          "is-error": _vm.validateState === "error",
          "is-validating": _vm.validateState === "validating",
          "is-success": _vm.validateState === "success",
          "is-required": _vm.isRequired || _vm.required,
          "is-no-asterisk": _vm.sdForm && _vm.sdForm.hideRequiredAsterisk
        },
        _vm.sizeClass ? "sd-form-item--" + _vm.sizeClass : ""
      ]
    },
    [
      _c(
        ...
        [
          _vm.label || _vm.$slots.label
            ? _c(
                "label",
                {
                  staticClass: "sd-form-item__label",
      ...
      _c(
        "div",
        { staticClass: "sd-form-item__content", style: _vm.contentStyle },
        [
          _vm._t("default"),
          _c(
            "transition",
                ...
                ? _vm._t(
                    ...
                    [
                      _c(
                        "div",
                        {
                          staticClass: "sd-form-item__error",
                          class: {
                            "sd-form-item__error--inline":
                              typeof _vm.inlineMessage === "boolean"
                                ? _vm.inlineMessage
                                : (_vm.sdForm && _vm.sdForm.inlineMessage) ||
                                  false
                          }
                        },
                        [
...
/* harmony default export */ var label_wrapvue_type_script_lang_js_ = ({
  ...
  render: function render() {
    ...
    if (this.isAutoWidth) {
      var autoLabelWidth = this.sdForm.autoLabelWidth;
      var style = {};
      ...
      return h(
        'div',
        { 'class': 'sd-form-item__label-wrap', style: style },
        [slots]
      );
    } else {
      return slots[0];
  ...
  methods: {
    validate: function validate(trigger) {
      ...
      validator.validate(model, { firstFields: true }, function (errors, invalidFields) {
        ...
        _this.sdForm && _this.sdForm.$emit('validate', _this.prop, !errors, _this.validateMessage || null);
      });
    },
