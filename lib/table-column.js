...
var forced = {
  ...
  expand: {
    ...
    renderCell: function renderCell(h, _ref6, proxy) {
      ...
      return h(
        'div',
        { 'class': 'sd-table__expand-icon ' + (expanded ? 'sd-table__expand-icon--expanded' : ''),
          on: {
        ...
        [h('i', { 'class': 'sd-icon sd-icon-arrow-right' })]
      );
    },
    sortable: false,
    resizable: false,
...
/* harmony default export */ var table_column = ({
  ...
  created: function created() {
    ...
    column.renderCell = function (h, data) {
      ...
      return _self.showOverflowTooltip || _self.showTooltipWhenOverflow ? h(
        'div',
        { 'class': 'cell sd-tooltip', style: { width: (data.column.realWidth || data.column.width) - 1 + 'px' } },
        [children]
      ) : h(
        'div',
        { 'class': 'cell' },
  ...
  methods: {
    renderTreeCell: function renderTreeCell(data) {
      ...
      var ele = [];
      ele.push(h('span', { 'class': 'sd-table__indent', style: { 'padding-left': data.treeNode.indent + 'px' } }));
      if (data.treeNode.hasChildren) {
        ele.push(h(
          'div',
          { 'class': ['sd-table__expand-icon', data.treeNode.expanded ? 'sd-table__expand-icon--expanded' : ''],
            on: {
        ...
        ele.push(h('span', { 'class': 'sd-table__placeholder' }));
      }
      return ele;
    },
