...
var render = function() {
  ...
  return _c("div", {
    staticClass: "sd-tabs__active-bar",
...
/* harmony default export */ var tab_navvue_type_script_lang_js_ = ({
  ...
  render: function render(h) {
    ...
    var scrollBtn = scrollable ? [h(
      'span',
      { 'class': ['sd-tabs__nav-prev', scrollable.prev ? '' : 'is-disabled'], on: {
          'click': scrollPrev
        }
      },
      [h('i', { 'class': 'sd-icon-arrow-left' })]
    ), h(
      'span',
      { 'class': ['sd-tabs__nav-next', scrollable.next ? '' : 'is-disabled'], on: {
          'click': scrollNext
        }
      },
      [h('i', { 'class': 'sd-icon-arrow-right' })]
    )] : null;
    ...
    var tabs = this._l(panes, function (pane, index) {
      ...
      var btnClose = closable ? h('span', { 'class': 'sd-icon-close', on: {
    ...
    return h(
      'div',
      { 'class': ['sd-tabs__nav-wrap', scrollable ? 'is-scrollable' : '', 'is-' + this.rootTabs.tabPosition] },
      [scrollBtn, h(
        'div',
        { 'class': ['sd-tabs__nav-scroll'], ref: 'navScroll' },
        [h(
          'div',
          {
...
/* harmony default export */ var tabsvue_type_script_lang_js_ = ({
    ...
    calcPaneInstances: function calcPaneInstances() {
      ...
      if (this.$slots.default) {
        var paneSlots = this.$slots.default.filter(function (vnode) {
          return vnode.tag && vnode.componentOptions && vnode.componentOptions.Ctor.options.name === 'SdTabPane';
        });
        // update indeed
  ...
  render: function render(h) {
    ...
    var header = h(
      'div',
      { 'class': ['sd-tabs__header', 'is-' + tabPosition] },
      [newButton, h('tab-nav', navData)]
    );
    var panels = h(
      'div',
      { 'class': 'sd-tabs__content' },
      [this.$slots.default]
    );
    ...
    return h(
      ...
      { 'class': (_ref2 = {
        ...
        }, _ref2['sd-tabs--' + tabPosition] = true, _ref2['sd-tabs--border-card'] = type === 'border-card', _ref2) },
