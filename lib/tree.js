...
module.exports = require("seedland-ui/lib/transitions/collapse-transition");
...
var render = function() {
  ...
  return _c(
    "div",
    {
      staticClass: "sd-tree",
      class: {
        "sd-tree--highlight-current": _vm.highlightCurrent,
    ...
    [
      ...
      _vm.isEmpty
        ? _c("div", { staticClass: "sd-tree__empty-block" }, [
            _c("span", { staticClass: "sd-tree__empty-text" }, [
      ...
      _c("div", {
        ...
        ref: "dropIndicator",
        staticClass: "sd-tree__drop-indicator"
      })
    ],
    2
  )
  ...
  return _c(
    ...
    [
      _c(
        "div",
        {
          staticClass: "sd-tree-node__content",
          style: {
        ...
        [
          _c("span", {
            class: [
              ...
              "sd-tree-node__expand-icon",
              _vm.tree.iconClass ? _vm.tree.iconClass : "sd-icon-caret-right"
            ],
            on: {
              click: function($event) {
                $event.stopPropagation()
          ...
          _vm.node.loading
            ? _c("span", {
                staticClass: "sd-tree-node__loading-icon sd-icon-loading"
              })
            : _vm._e(),
        ...
        !_vm.renderAfterExpand || _vm.childNodeRendered
          ? _c(
              "div",
              {
                ...
                staticClass: "sd-tree-node__children",
...
// EXTERNAL MODULE: external "seedland-ui/lib/transitions/collapse-transition"
...
/* harmony default export */ var tree_nodevue_type_script_lang_js_ = ({
  ...
  components: {
    SdCollapseTransition: collapse_transition_default.a,
  ...
  methods: {
    ...
    handleChildNodeExpand: function handleChildNodeExpand(nodeData, node, instance) {
      this.broadcast('SdTreeNode', 'tree-node-expand', node);
...
/* harmony default export */ var treevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    handleKeydown: function handleKeydown(ev) {
      ...
      if (currentItem.className.indexOf('sd-tree-node') === -1) return;
  ...
  created: function created() {
    ...
    this.$on('tree-node-drag-over', function (event, treeNode) {
      var dropNode = findNearestComponent(event.target, 'SdTreeNode');
      ...
      var iconPosition = dropNode.$el.querySelector('.sd-tree-node__expand-icon').getBoundingClientRect();
