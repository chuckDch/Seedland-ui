...
Seedland 内应用在部分组件的过渡动画，你也可以直接使用。在使用之前请阅读 [transition 组件文档](https://cn.vuejs.org/v2/api/#transition) 。
...
```js
// fade/zoom 等
import 'seedland-ui/lib/theme-chalk/base.css';
// collapse 展开折叠
import CollapseTransition from 'seedland-ui/lib/transitions/collapse-transition';
import Vue from 'vue'
