...
:::demo
```html
<sd-tree :data="data" :props="defaultProps" @node-click="handleNodeClick"></sd-tree>
...
<div class="buttons">
  <sd-button @click="getCheckedNodes">通过 node 获取</sd-button>
  <sd-button @click="getCheckedKeys">通过 key 获取</sd-button>
  <sd-button @click="setCheckedNodes">通过 node 设置</sd-button>
  <sd-button @click="setCheckedKeys">通过 key 设置</sd-button>
  <sd-button @click="resetChecked">清空</sd-button>
</div>
      ...
      renderContent(h, { node, data, store }) {
        return (
          <span class="custom-tree-node">
            <span>{node.label}</span>
            <span>
              <sd-button size="mini" type="text" on-click={ () => this.append(data) }>Append</sd-button>
              <sd-button size="mini" type="text" on-click={ () => this.remove(node, data) }>Delete</sd-button>
            </span>
          </span>);
      }
    }
