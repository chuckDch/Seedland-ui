...
```html
<template>
  <sd-transfer v-model="value" :data="data"></sd-transfer>
</template>
...
<template>
  ...
  <div style="text-align: center">
    <sd-transfer
      ...
      @change="handleChange"
      :data="data">
      <sd-button class="transfer-footer" slot="left-footer" size="small">操作</sd-button>
      <sd-button class="transfer-footer" slot="right-footer" size="small">操作</sd-button>
    </sd-transfer>
  </div>
